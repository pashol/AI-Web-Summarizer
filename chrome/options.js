...
document.getElementById('metricsEnabled').addEventListener('change', (e) => {
...
document.getElementById('saveBtn').addEventListener('click', () => {
  ...
  chrome.storage.local.set({ provider, apiKeys: currentApiKeys, model, language, articleTextLimit: articleTextLimitRaw, ttsRate, ttsPitch, ttsVoice, streaming, theme }, () => {
    const msg = document.getElementById('statusMsg');
