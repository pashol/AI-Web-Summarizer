...
- **1.0.11**: Current version (fix context menu not appearing after Firefox restart)
- **1.0.10**: Security fix for unsafe innerHTML in result.js
- **1.0.9**: Previous version
- **1.0.7**: Documentation creation
